...
public class AdminLaporan3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_laporan3);

        ref = FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit3");
        ...
        ft_btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminLaporan3.this, Unit3LaporanTambah.class);
        ...
        adapter = new FirebaseRecyclerAdapter<AdapterLaporan, ViewHolderLaporan>(optionsLaporan) {
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderLaporan holder, final int position, @NonNull AdapterLaporan model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(AdminLaporan3.this,Unit3LaporanIsi.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit3").child(getRef(position).getKey()).removeValue();

                                Intent intent = new Intent(AdminLaporan3.this,AdminLaporan3.class);
                                Toast.makeText(AdminLaporan3.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminLaporan3.this, AdminLaporanMain.class);
        startActivity(intent);
        finish();
    }
}