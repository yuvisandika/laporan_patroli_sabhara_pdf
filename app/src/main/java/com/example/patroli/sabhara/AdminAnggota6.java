...
public class AdminAnggota6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota6);
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("Anggota").child("Unit6");
        ...
        ft_unittambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminAnggota6.this,AdminAnggota6Tambah.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("Anggota").child("Unit6").child(getRef(position).getKey()).removeValue();

                                Intent intent = new Intent(AdminAnggota6.this,AdminAnggota6.class);
                                Toast.makeText(AdminAnggota6.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminAnggota6.this, AdminAnggotaMain.class);
        startActivity(intent);
        finish();
    }
}