...
public class AdminAnggota3Tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota3_tambah);
        ...
        sref = FirebaseStorage.getInstance().getReference().child("Anggota").child("Unit3");
        ...
        btnupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AdminAnggota3Tambah.this, "Mohon Masukan Gambar", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        ref.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                startActivity(new Intent(getApplicationContext(),AdminAnggota3.class));
                                Toast.makeText(AdminAnggota3Tambah.this, "Sukses", Toast.LENGTH_SHORT).show();
