...
public class AdminAnggota2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota2);
        ...
        ft_unittambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminAnggota2.this,AdminAnggota2Tambah.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("Anggota").child("Unit2").child(getRef(position).getKey()).removeValue();

                                Intent intent = new Intent(AdminAnggota2.this,AdminAnggota2.class);
                                Toast.makeText(AdminAnggota2.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminAnggota2.this, AdminAnggotaMain.class);
        startActivity(intent);
        finish();
    }
}