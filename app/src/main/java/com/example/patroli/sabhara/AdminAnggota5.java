...
public class AdminAnggota5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota5);
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("Anggota").child("Unit5");
        ...
        ft_unittambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminAnggota5.this,AdminAnggota5Tambah.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("Anggota").child("Unit5").child(getRef(position).getKey()).removeValue();

                                Intent intent = new Intent(AdminAnggota5.this,AdminAnggota5.class);
                                Toast.makeText(AdminAnggota5.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminAnggota5.this, AdminAnggotaMain.class);
        startActivity(intent);
        finish();
    }
}