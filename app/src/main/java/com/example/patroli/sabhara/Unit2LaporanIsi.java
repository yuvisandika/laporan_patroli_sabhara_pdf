...
public class Unit2LaporanIsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit2_laporan_isi);
        ...
        btn_jam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timePickerDialog = new TimePickerDialog(Unit2LaporanIsi.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        DataRef = FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit2").child(LaporanKey);
        ...
        btn_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Unit2LaporanIsi.this, "Data Berhasil Diisi", Toast.LENGTH_LONG).show();
