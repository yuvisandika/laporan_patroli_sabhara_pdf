...
public class Unit3LaporanIsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit3_laporan_isi);
        ...
        btn_jam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timePickerDialog = new TimePickerDialog(Unit3LaporanIsi.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        DataRef = FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit3").child(LaporanKey);
        ...
        btn_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Unit3LaporanIsi.this, "Data Berhasil Diisi", Toast.LENGTH_LONG).show();
