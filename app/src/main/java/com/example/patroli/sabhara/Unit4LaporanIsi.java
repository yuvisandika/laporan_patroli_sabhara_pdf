...
public class Unit4LaporanIsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit4_laporan_isi);
        ...
        btn_jam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timePickerDialog = new TimePickerDialog(Unit4LaporanIsi.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        DataRef = FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit4").child(LaporanKey);
        ...
        btn_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Unit4LaporanIsi.this, "Data Berhasil Diisi", Toast.LENGTH_LONG).show();
