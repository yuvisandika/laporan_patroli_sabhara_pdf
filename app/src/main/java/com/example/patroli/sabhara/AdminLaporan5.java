...
public class AdminLaporan5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_laporan5);

        ref = FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit5");
        ...
        ft_btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminLaporan5.this, Unit5LaporanTambah.class);
        ...
        adapter = new FirebaseRecyclerAdapter<AdapterLaporan, ViewHolderLaporan>(optionsLaporan) {
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderLaporan holder, final int position, @NonNull AdapterLaporan model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(AdminLaporan5.this,Unit5LaporanIsi.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit5").child(getRef(position).getKey()).removeValue();

                                Intent intent = new Intent(AdminLaporan5.this,AdminLaporan5.class);
                                Toast.makeText(AdminLaporan5.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminLaporan5.this, Unit5Home.class);
        startActivity(intent);
        finish();
    }
}