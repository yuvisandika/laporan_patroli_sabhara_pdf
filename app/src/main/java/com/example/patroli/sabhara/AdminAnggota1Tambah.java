...
public class AdminAnggota1Tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota1_tambah);
        ...
        sref = FirebaseStorage.getInstance().getReference().child("Anggota").child("Unit1");
        ...
        btnupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AdminAnggota1Tambah.this, "Mohon Masukan Gambar", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        ref.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                startActivity(new Intent(getApplicationContext(),AdminAnggota1 .class));
                                Toast.makeText(AdminAnggota1Tambah.this, "Sukses", Toast.LENGTH_SHORT).show();
