...
public class Unit2Laporan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit2_laporan);
        ...
        ft_btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Unit2Laporan.this, Unit2LaporanTambah.class);
        ...
        adapter = new FirebaseRecyclerAdapter<AdapterLaporan, ViewHolderLaporan>(optionsLaporan) {
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderLaporan holder, final int position, @NonNull AdapterLaporan model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Unit2Laporan.this,Unit2LaporanIsi.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent intent = new Intent(Unit2Laporan.this,Unit2Laporan.class);
                                Toast.makeText(Unit2Laporan.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Unit2Laporan.this, Unit2Home.class);
        startActivity(intent);
        finish();
    }
}