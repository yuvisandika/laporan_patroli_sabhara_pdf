...
public class Unit3Laporan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit3_laporan);
        ...
        ft_btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Unit3Laporan.this, Unit3LaporanTambah.class);
        ...
        adapter = new FirebaseRecyclerAdapter<AdapterLaporan, ViewHolderLaporan>(optionsLaporan) {
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderLaporan holder, final int position, @NonNull AdapterLaporan model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Unit3Laporan.this,Unit3LaporanIsi.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent intent = new Intent(Unit3Laporan.this,Unit3Laporan.class);
                                Toast.makeText(Unit3Laporan.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Unit3Laporan.this, Unit3Home.class);
        startActivity(intent);
        finish();
    }
}