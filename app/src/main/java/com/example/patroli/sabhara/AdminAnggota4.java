...
public class AdminAnggota4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota4);
        ...
        ft_unittambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminAnggota4.this,AdminAnggota4Tambah.class);
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("Anggota").child("Unit4").child(getRef(position).getKey()).removeValue();

                                Intent intent = new Intent(AdminAnggota4.this,AdminAnggota4.class);
                                Toast.makeText(AdminAnggota4.this, "Data Berhasi Dihapus", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                                finish();
                            }
                        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminAnggota4.this, AdminAnggotaMain.class);
        startActivity(intent);
        finish();
    }
}