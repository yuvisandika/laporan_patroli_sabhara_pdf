...
public class AdminAnggota2Tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota2_tambah);
        ...
        sref = FirebaseStorage.getInstance().getReference().child("Anggota").child("Unit2");
        ...
        btnupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AdminAnggota2Tambah.this, "Mohon Masukan Gambar", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        ref.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                startActivity(new Intent(getApplicationContext(),AdminAnggota2.class));
                                Toast.makeText(AdminAnggota2Tambah.this, "Sukses", Toast.LENGTH_SHORT).show();
