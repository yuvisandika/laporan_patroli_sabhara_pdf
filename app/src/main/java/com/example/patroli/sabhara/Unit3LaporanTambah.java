...
public class Unit3LaporanTambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit3_laporan_tambah);
        ...
        btn_tgl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        Unit3LaporanTambah.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth
        ...
        btn_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txt_tgl.getText().toString())) {
                    Toast.makeText(Unit3LaporanTambah.this, "Silahkan Pilih Tanggal", Toast.LENGTH_SHORT).show();
                }
                //upload
                else {
    ...
    private void uplaod(String tanggal) {
        ...
        ref.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Unit3LaporanTambah.super.onBackPressed();
                Toast.makeText(Unit3LaporanTambah.this, "Laporan Berhasil Dibuat", Toast.LENGTH_SHORT).show();
