...
public class AdminAnggota5Tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_anggota5_tambah);
        ...
        sref = FirebaseStorage.getInstance().getReference().child("Anggota").child("Unit5");
        ...
        btnupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AdminAnggota5Tambah.this, "Mohon Masukan Gambar", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        ref.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                startActivity(new Intent(getApplicationContext(),AdminAnggota5.class));
                                Toast.makeText(AdminAnggota5Tambah.this, "Sukses", Toast.LENGTH_SHORT).show();
