...
public class Unit5LaporanIsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit5_laporan_isi);
        ...
        btn_jam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                timePickerDialog = new TimePickerDialog(Unit5LaporanIsi.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        DataRef = FirebaseDatabase.getInstance().getReference().child("Laporan").child("Unit5").child(LaporanKey);
        ...
        btn_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Unit5LaporanIsi.this, "Data Berhasil Diisi", Toast.LENGTH_LONG).show();
